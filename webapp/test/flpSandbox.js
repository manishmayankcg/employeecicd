		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "employee cicd",
									"targetURL": "#sampleemployeecicd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sampleemployeecicd-display": {
								"semanticObject": "sampleemployeecicd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sample.employeecicd",
									"url": sap.ui.require.toUrl("sample/employeecicd")
								}
							}
						}
					}
